...
class TestOptions():
    def initialize(self):
        ...
        parser.add_argument("--data-list-target", type=str, default='/content/FDA/dataset/target_list/val.txt', help="list of images in the target dataset.")
      ...
      #  parser.add_argument("--restore-opt2", type=str, default=None, help="restore model parameters from beta2")  ##FOR multiple models MODEL
       # parser.add_argument("--restore-opt3", type=str, default=None, help="restore model parameters from beta3")    ## FOR multiple models MODEL
        ...
        parser.add_argument('--gt_dir', type=str, default='/content/FDA/data_robust/target_masks', help='directory for CityScapes val gt images')
        parser.add_argument('--devkit_dir', type=str, default='/content/FDA/dataset/target_list', help='list directory of cityscapes')         
